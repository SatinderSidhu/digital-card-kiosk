...
export function PhotoSection({ state }: Props) {
  ...
  return (
    <SectionFrame
      ...
      subtitle={photo ? "Looks great — tap Update Info to add your details" : "Smile! Tap capture when you're ready"}
      state={state}
    >
            ...
            <AnimatePresence>
              {photo && (
                <>
                  ...
                  {/* Continue — sits where DIGITAL CARD tag would be, inside the info column */}
                  <motion.button
                    key="continue"
